...
const steps = [
  { title: '老板提出目标', role: 'Boss', text: '两周内看到仿真闭环演示', color: 'boss' },
  { title: 'PM 建 Project', role: 'PM', text: '定义目标、边界、验收口径', color: 'pm' },
  { title: '拆 Milestone', role: 'PM', text: '场景搭建 / 规划闭环 / 演示验收', color: 'pm' },
  ...
  { title: 'Risk 升级', role: 'PM', text: '影响 Milestone 的不确定性单独追踪', color: 'risk' },
  { title: '老板验收', role: 'Boss', text: 'PM 将技术证据翻译为业务结论', color: 'boss' },
